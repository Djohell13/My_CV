...
* **Modélisation avancée** : Utilisation du modèle **XGBoost Survival Cox** pour prédire le "Time-to-Event".
* **Déploiement** : Application Streamlit orientée aide à la décision pour les utilisateurs opérationnels.
